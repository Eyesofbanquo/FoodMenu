...
class MealTableViewController: UITableViewController {
    ...
    func loadSampleMeals(){
        ...
        let meal1 = Meal(name: "Burger", image: photo1, rating: 4)!
        
        let photo2 = UIImage(named: "meal2")
        let meal2 = Meal(name: "Cheese", image: photo2, rating: 5)!
        
        let photo3 = UIImage(named: "meal5")
        let meal3 = Meal(name: "Fries", image: photo3, rating: 2)!
        
        //meals += [Meal(name: "yes", image: photo1, rating: 3)]
